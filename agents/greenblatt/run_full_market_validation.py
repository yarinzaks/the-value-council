"""Greenblatt validation on the **full US market** (not just S&P 500).
...
Usage::
    ...
    .venv/bin/python -m agents.greenblatt.run_full_market_validation
"""
...
def main() -> None:
    ...
    strategy = MagicFormula(
        portfolio_size=30,
        # Raised to $500M per priority spec — combined with the
        # universe-level positive-book + 2-year-revenue filters, this
        # eliminates the bulk of micro-cap data anomalies.
    ...
    print()
    print("=" * 60)
    print("GREENBLATT MAGIC FORMULA — FULL US MARKET (2010-2024)")
    print("=" * 60)
